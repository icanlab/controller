...
from ..models.input_msg import InputMsg  # noqa: E501
...
class TestDefaultController(BaseTestCase):
    ...
    def test_datastore_get_device_config_get(self):
        ...
        response = self.client.open(
            "/v1/datastore/get_device_config", method="GET", query_string=query_string
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
    ...
    def test_datastore_query_device_config_get(self):
        ...
        response = self.client.open(
            "/v1/datastore/query_device_config", method="GET", query_string=query_string
        )
        self.assert200(response, "Response body is : " + response.data.decode("utf-8"))
